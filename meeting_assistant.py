...
예:
  python meeting_assistant.py status   --vault "D:\\Obsidian\\MyVault"
  python meeting_assistant.py prep      --vault "D:\\Obsidian\\MyVault"
  python meeting_assistant.py schedule  --vault "D:\\Obsidian\\MyVault" --write-dashboard
  python meeting_assistant.py process   회의녹음.m4a --title "주간보고" --type meeting
  python meeting_assistant.py merge      --vault "D:\\Obsidian\\MyVault"
  python meeting_assistant.py record    --type meeting --topic "주간보고"
"""
...
def main():
    ...
    p = sub.add_parser("process", help="회의 후: 파일 처리(STT~메일~매칭)")
