...
SCHEMA: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {"section": "wiki", "key": "realtime_paper_candidates", "label": "실시간 논문 후보 수", "type": "number", "default": 4, "desc": "위 후보에 더해 논문/이론 폴더만 따로 검색해 추가할 개수. 로컬 논문이 일반 노트에 밀려 후보에서 빠지는 것을 막습니다(동점이면 논문을 앞에 표시)."},
