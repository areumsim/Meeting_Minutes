...
SCHEMA: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {"section": "wiki", "key": "realtime_section_candidates", "label": "실시간 섹션 후보 수", "type": "number", "default": 12, "desc": "발화별로 모을 내부 섹션(헤딩) 후보 개수. 넉넉히 모으고 화면에는 상위 몇 개만 보여줍니다(나머지는 종료 후 '참조된 관련 노트'에서 확인)."},
