...
CLI:
    python run_meeting.py schedule --vault "D:\\Claude\\QC"                  # 일정+충돌 출력
    python run_meeting.py schedule --vault "..." --write-dashboard           # 대시보드 노트 갱신
    python run_meeting.py schedule --vault "..." --days 14                   # 향후 14일만
