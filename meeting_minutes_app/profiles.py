...
사용 예:
    python run_meeting.py batch input.mp4 --profile weekly
    python run_meeting.py profiles list               # 목록 보기
    python run_meeting.py profiles create             # 대화형 생성
    python run_meeting.py profiles show weekly_team   # 상세 보기
"""
    ...
    def apply_profile(self, name: str, args: Any) -> Any:
        ...
        if profile is None:
            ...
            raise ValueError(
                ...
                f"사용 가능: {available}\n"
                f"  python run_meeting.py profiles list 로 전체 목록 확인"
            )
...
if __name__ == "__main__":
    ...
    if cmd == "list":
        ...
        print(f"\n  사용: python run_meeting.py batch input.mp4 --profile <이름>")
        ...
        print("사용법:")
        print("  python run_meeting.py profiles list              # 프로필 목록")
        print("  python run_meeting.py profiles create            # 대화형 생성")
        print("  python run_meeting.py profiles show <이름>       # 프로필 상세")
        print("  python run_meeting.py profiles delete <이름>     # 프로필 삭제")
