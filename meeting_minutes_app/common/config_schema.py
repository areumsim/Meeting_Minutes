...
SCHEMA: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {"section": "wiki", "key": "related_notes_max_rank", "label": "회의록에 실을 관련 노트 순위 상한", "type": "number", "default": 0, "desc": "0=제한 없음. 예: 5로 두면 녹음 중 검색에서 상위 5위 안에 든 적이 있는 노트만 회의록 '🔗 관련 노트'에 싣습니다(노이즈 컷). 녹음 화면 표시와 회의 상세의 누적 목록에는 영향이 없습니다."},
