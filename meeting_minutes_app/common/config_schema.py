...
SCHEMA: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "fields": [
            ...
            {"section": "wiki", "key": "realtime_search_interval", "label": "실시간 검색 간격(세그먼트)", "type": "number", "default": 3, "desc": "발화 N개마다 한 번 관련 노트를 찾습니다. 1로 두면 매 발화마다 검색합니다(가장 촘촘하지만 느려질 수 있음). 0이나 빈 값은 기본값 3으로 처리됩니다 — '0=매 발화'가 아닙니다."},
